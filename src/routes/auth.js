 ...
 */
/*
 * DEPRECATED: This route has been replaced by the root-level /Shibboleth.sso/Login route
 * to match the IdP metadata. The new route is handled in `src/routes/shibboleth.js`.
 * This block is kept for reference but should be removed in the future.
 */
 ...
 */
/*
 * DEPRECATED: This route has been replaced by the root-level /Shibboleth.sso/SAML2/POST route
 * to match the IdP metadata. The new route is handled in `src/routes/shibboleth.js`.
 * This block is kept for reference but should be removed in the future.
 */
